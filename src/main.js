...
const modelsData = [
  {
    ...
    desktop: { position: [-4, 1.6, 0], scale: [1.2, 1.2, 1.2] },
  ...
  {
    path: "/models/fra.glb",
    desktop: { position: [4, -2.4, 0], scale: [1, 1, 1] },
    tablet: { position: [2, -2, 0], scale: [1, 1, 1] },
